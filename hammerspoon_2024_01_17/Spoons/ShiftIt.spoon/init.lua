...
obj.mapping = {
  ...
  leftquarter = { obj.mash, 'l' },
  rightquarter = { obj.mash, ';' },
  right45 = { obj.mash, '\'' },
  botleft3quarter = { obj.mash, ',' },
  botrigh3quarter = { obj.mash, '.' },
}
...
local units = {
  ...
  leftquarter  = function(x, _) return { x = 0.00, y = 0.00, w = x / 75, h = 1.00 } end,
  rightquarter = function(x, _) return { x = 1 - (x / 75), y = 0.00, w = x / 75, h = 1.00 } end,
  right45 = function(x, _) return { x = 1 - (x / 60), y = 0.00, w = x / 60, h = 1.00 } end,
  botleft3quarter  = function(x, y) return { x = 0.00, y = 1 - (y / 75), w = x / 100, h = y / 75 } end,
  botrigh3quarter = function(x, y) return { x = 1 - (x / 100), y = 1 - (y / 75), w = x / 100, h = y / 75 } end,
...
function obj:botrigh3quarter() self:moveWithCycles(units.botrigh3quarter) end
function obj:botleft3quarter() self:moveWithCycles(units.botleft3quarter) end
function obj:leftquarter() self:moveWithCycles(units.leftquarter) end
function obj:rightquarter() self:moveWithCycles(units.rightquarter) end
function obj:right45() self:moveWithCycles(units.right45) end
...
function obj:center()
  ...
  self:moveWithCycles(units.botrigh3quarter)
...
function obj:bindHotkeys(mapping)
  ...
  self.hs.hotkey.bind(self.mapping.leftquarter[1], self.mapping.leftquarter[2], function() self:leftquarter() end)
  self.hs.hotkey.bind(self.mapping.rightquarter[1], self.mapping.rightquarter[2], function() self:rightquarter() end)
  self.hs.hotkey.bind(self.mapping.right45[1], self.mapping.right45[2], function() self:right45() end)
  self.hs.hotkey.bind(self.mapping.botrigh3quarter[1], self.mapping.botrigh3quarter[2], function() self:botrigh3quarter() end)
  self.hs.hotkey.bind(self.mapping.botleft3quarter[1], self.mapping.botleft3quarter[2], function() self:botleft3quarter() end)
